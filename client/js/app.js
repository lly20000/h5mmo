    ...
    var App = Class.extend({
        ...
        initAchievementList: function(achievements) {
            ...
            _.each(achievements, function(achievement) {
                ...
                $a.find('.twitter').attr('href', 'http://twitter.com/share?url=http%3A%2F%2Fblog.csdn.net/lly20000&text=我%20解锁了%20一个%20%27'+ achievement.name +'%27%20的成就%20在%20技术部的%20%23伪娘唐唐大冒险%21&related=glecollinet:Creators%20of%20BrowserQuest%2Cwhatthefranck');
                $a.show();
